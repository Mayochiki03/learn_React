...
function Header({ pageName, showCart, setShowCart }: { pageName: string; showCart: boolean; setShowCart: (value: boolean) => void }) {
  return (
    <>
            ...
            <ul className="flex space-x-4  items-center">
              ...
              <li className="mr-6 p-1">
                <button
                  ...
                  onClick={() => setShowCart(!showCart)} // เมื่อกดปุ่มจะเปลี่ยนค่าของ showCart
