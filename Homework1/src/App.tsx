...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <Header pageName="Books" showCart = {showCart} setShowCart = {setShowCart} />
      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        ...
        {
          showCart? (
            <Cart cartItems={cartItems} updateQuantity={updateQuantity} totalPrice={totalPrice} removeFromCart={removeFromCart} />
          ):null
